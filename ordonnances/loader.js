...
(function() {
  ...
  const scripts = [
    ...
    'print-handler.js',
    // TODO: revert to 'copy-handler.js' once jsDelivr @main cache has propagated (pinned 2026-02-22)
    'https://cdn.jsdelivr.net/gh/william-ordotype/ordotype-scripts@e8f61e8/ordonnances/copy-handler.js'
  ];
