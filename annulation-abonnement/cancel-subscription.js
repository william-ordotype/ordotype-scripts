/**
 * Ordotype - Cancel Subscription
 * Handles subscription cancellation and retention offer (50% discount) flows.
 *
 * Page: /membership/annulation-abonnement
 *
...
(function() {
  ...
  const PREFIX = '[CancelSubscription]';
