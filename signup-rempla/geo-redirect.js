/**
 * Geographic Redirect for Signup Rempla
...
(function(g, e, o, t, a, r, ge, tl, y, s) {
    ...
    s = function() {
        ...
        revealed = true;
        g.getElementById('georedirect1714398961109style').innerHTML = 'body{opacity:1.0 !important;}';
    };
    ...
    if (hidden) {
        g.getElementsByTagName(o)[0].insertAdjacentHTML(
            'afterbegin',
            '<style id="georedirect1714398961109style">body{opacity:0.0 !important;}</style>'
        );
    ...
    window.georedirect1714398961109loaded = function(redirect) {
        cancelSafety();
        if (!hidden) return;
        var to = 0;
        if (redirect) { to = 5000; }
